...
const TEXT_COLOR: Record<string, string> = { active: '#ffffff', upcoming: '#ffffff', late: '#ffffff', done: '#6B7280' }
  ...
  return (
    <div className="large-widget">
      <div className="widget-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}><Link to={ROUTES.schedule} className="widget-link">View all schedules →</Link>{gripNode}</div>
      </div>

      {/* Alert — clock badge removed; top margin handled by CSS */}
