...
export const EMPLOYEES: Employee[] = [
  ...
  { ...emp('e001','Maria Santos',    'maria.santos@abroadworks.com',    'MS','#DBEAFE','#1E40AF','Operations Manager',  'abroadworker','cl-acme',    'active',     'fixed',        14,22,[],                                                                           ['Internal Ops','HR Processes'],            'America/New_York', 'full-time',  'monthly',  85,  5200, true,  '2021-03-15'), scheduleAdjustments: SCHEDULE_ADJUSTMENTS.filter(a => a.employeeId === 'e001'), scheduleLimit: { weeklyHours: 40, dailyHours: 8 } },
  { ...emp('e002','James Rivera',    'james.rivera@abroadworks.com',    'JR','#D1FAE5','#065F46','Backend Engineer',    'abroadworker','cl-acme',    'active',     'fixed',        14,22,[],                                                                           ['API Integration','Mobile App v2'],        'America/New_York', 'full-time',  'hourly',   90,  45,   true,  '2021-06-01'), scheduleAdjustments: SCHEDULE_ADJUSTMENTS.filter(a => a.employeeId === 'e002'), scheduleLimit: { weeklyHours: 40 } },
  { ...emp('e003','Carla Reyes',     'carla.reyes@abroadworks.com',     'CR','#FEF3C7','#92400E','Product Designer',    'abroadworker','cl-acme',    'active',     'free-overlap', null,null,[{label:'Design sync',startUTC:15,endUTC:16},{label:'Sprint review',startUTC:18,endUTC:19}], ['Dashboard UI','Client Portal Redesign'],  'America/New_York', 'full-time',  'hourly',   75,  38,   true,  '2022-01-10'), scheduleLimit: { dailyHours: 8 } },
  ...
  { ...emp('e006','Daniel Abreu',    'daniel.abreu@abroadworks.com',    'DA','#FAECE7','#712B13','Copywriter',          'abroadworker','cl-acme',    'active',     'free-overlap', null,null,[{label:'Editorial call',startUTC:16,endUTC:17}],                          ['Content Strategy'],                       'America/New_York', 'part-time',  'hourly',   55,  28,   false, '2023-02-14'), scheduleLimit: { weeklyHours: 20 } },

  // ── Vero Health ────────────────────────────────────────────────────────────
  { ...emp('e007','Rachel Cohen',    'rachel.cohen@abroadworks.com',    'RC','#ECFDF5','#064E3B','QA Engineer',         'chabadworker','cl-vero',    'active',     'fixed',         1, 9,[],                                                                           ['Mobile App QA','API Integration'],        'Asia/Manila',      'full-time',  'hourly',   70,  35,   true,  '2021-09-01'), scheduleLimit: { weeklyHours: 40, dailyHours: 8 } },
  ...
  { ...emp('e009','Yael Mizrahi',    'yael.mizrahi@abroadworks.com',    'YM','#FFF7ED','#9A3412','Content Strategist',  'chabadworker','cl-vero',    'active',     'free-overlap', null,null,[{label:'Content review',startUTC:2,endUTC:3},{label:'Client call',startUTC:5,endUTC:6}],    ['Content Strategy','Brand Identity'],      'Asia/Manila',      'contractor', 'hourly',   60,  30,   false, '2022-05-20'), scheduleLimit: { dailyHours: 6 } },
  ...
  { ...emp('e013','Marcus Webb',     'marcus.webb@abroadworks.com',     'MW','#E6F1FB','#0C447C','Backend Engineer',    'abroadworker','cl-bluesky', 'active',     'fixed',        14,22,[],                                                                           ['API Integration','Security Audit'],       'America/New_York', 'contractor', 'hourly',   95,  50,   true,  '2023-01-03'), scheduleLimit: { weeklyHours: 30 } },
  ...
  { ...emp('e016','Priya Nair',      'priya.nair@abroadworks.com',      'PN','#EAF3DE','#27500A','UX Researcher',       'abroadworker','cl-nova',    'active',     'free-overlap', null,null,[{label:'Research sync',startUTC:15,endUTC:16}],                           ['Dashboard UI'],                           'America/New_York', 'contractor', 'hourly',   80,  40,   false, '2023-03-01'), scheduleLimit: { weeklyHours: 25 } },
  ...
  { ...emp('e019','Ray Tanaka',      'ray.tanaka@abroadworks.com',      'RT','#EEEDFE','#3C3489','Scrum Master',        'chabadworker','cl-brex',    'active',     'fixed',         1, 9,[],                                                                           ['Mobile App v2'],                          'Asia/Manila',      'full-time',  'monthly',  90,  5500, true,  '2022-07-18'), scheduleLimit: { weeklyHours: 40, dailyHours: 8 } },
  ...
  { ...emp('e022','Ben Hoang',       'ben.hoang@abroadworks.com',       'BH','#D1FAE5','#065F46','DevOps Engineer',     'chabadworker','cl-kabad',   'onboarding', 'fixed',         1, 9,[],                                                                           ['Security Audit'],                         'Asia/Manila',      'full-time',  'hourly',   85,  42,   true,  '2024-01-08'), scheduleLimit: { weeklyHours: 40 } },
  ...
  { ...emp('e026','Amy Chen',        'amy.chen@abroadworks.com',        'AC','#FFF7ED','#9A3412','SEO Specialist',     'abroadworker','cl-pinewave', 'active',     'free',         null,null,[],                                                                           ['Content Strategy'],                       'America/New_York', 'part-time',  'hourly',   55,  28,   false, '2023-08-21'), scheduleLimit: { weeklyHours: 20, dailyHours: 6 } },
